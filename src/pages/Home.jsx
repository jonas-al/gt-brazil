  ...
  return (
    <div className="bg-gray-100">
      <div className='flex flex-col w-full'>
        ...
        <section className='flex flex-col w-2/3 h-full justify-between font-montserrat text-xl px-20 gap-y-10'>
          ...
          <div className='w-full grid grid-cols-2 grid-row-2 gap-4 text-gray-600 text-justify'>
      ...
      <footer className='flex h-44 w-full bg-[#75233D] mt-10 p-4 gap-x-10'>
        ...
        <div className='flex flex-col text-xl text-white font-bold gap-y-2'>
          Contatos
          <p className='text-md font-normal'>
            Prof. Doriedson Rodrigues (Coordenador do GT 09) <br />
            <a
          ...
          <p className='text-md font-normal'>
            Prof. Lucas Pelissari (Vice-Coordenador do GT 09) <br />
            <a
